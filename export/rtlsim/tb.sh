...
docker run --rm --user $(id -u):$(id -g) -e HOME=/tmp -e CCACHE_DIR=/tmp/ccache --entrypoint bash -v /home/alex/finn_build_mdanilow:/home/alex/finn_build_mdanilow -v /home/alex/Repos:/home/alex/Repos \
